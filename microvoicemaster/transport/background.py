...
from voicemaster import PseudoMIDI, CheetSheet
...
async def ensure_voices_bg(voices: PseudoMIDI, cheet_sheet: CheetSheet):
    ...
    microaccountant_response = await post_single_request(endpoint, construct_voice_data(voices, cheet_sheet), session=session)
